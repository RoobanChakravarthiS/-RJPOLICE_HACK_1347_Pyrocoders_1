    ...
    <main class="main">
        <section id="overflow">
            <section class="redirect">
                ...
                <div id="img1"></div>
                <p>to the official rajasthan police portal<br><font id="re">click to redirect.</font></p>
            </button>
            <button id="box" onclick="redirect('police-feedback.html')">
                <div id="img"></div>
                <p>give us your valuable feedback to enchance our productivity.<br><font id="re">click to redirect.</font></p>
            </button>
            <button id="box" onclick="redirect('#')">
                <div id="img2"></div>
                <p>to get details and to provide feedback about you FIR case.<br><font id="re">click to redirect.</font></p>
            </button>
        </section>
    </section>
    <section class="map">
