        ...
        <body>
            ...
            <section class="bg">  
                ...
                <div id="feedback-form">
                    ...
                    <label for="district" style="font-size: larger; font-weight: bolder; color: white;">Select District: | 
जिला चयन करें:</label>
                    <select id="district" name="district" aria-placeholder=" " style="font-size: larger; font-weight: bolder; color: Black;" onchange="updatePoliceStations()">
                        <option value="Jaipur">Jaipur</option>
                        <option value="Udaipur">Udaipur</option>
                    </select>
                    <label for="policeStation" style="font-size: larger; font-weight: bolder; color: white;">Select Police Station:
पुलिस स्टेशन चयन करें:</label>
                    <select id="policeStation" name="policeStation" style="font-size: larger; font-weight: bolder; color: Black;">
                </select>
                    <label for="name" class="input_label" style="font-size: larger; font-weight: bolder; color: white;">Officer Name | 
अधिकारी का नाम:</label>
                    <input type="text" id="name" name="offname" placeholder="" required class="input_field">


                    <label style="font-size: larger; font-weight: bolder; color: white;" for="name" class="input_label">Mobile Number | 
मोबाइल नंबर:</label>
                        ...
                        <label for="otp" class="input_label" style="font-size: larger; font-weight: bolder; color: white;">OTP  | 
अधिकारी का नाम:</label>
                        <input type="text" id="otp" name="otp" placeholder=""  class="input_field">
                        
                        <label style="font-size: larger; font-weight: bolder; color: white;" for="rating1">Rating:<font color="lightgrey">(Sincerity)</font></label>
                        ...
                        <label style="font-size: larger; font-weight: bolder; color: white;">Feedback:</label>
